...
assert_file_has "$USING" "Tier 2" "using-skillwiki names Tier 2 for work-item close"
assert_file_has "$MCP" "Tier 2" "skillwiki-mcp names unpublished Tier 2"
assert_file_has "$MCP" "wiki_workitem_write" "skillwiki-mcp names unpublished workitem tool"
